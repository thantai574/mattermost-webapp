    ...
    buildTextSetting = (id, setting) => {
        return (
            <TextSetting
                ...
                helpText={this.renderHelpText(setting)}
                placeholder={Utils.localizeMessage(setting.placeholder)}
                value={this.state[id] || ''}
        ...
        return (
            ...
            >
                <div className='banner__content'>
                    <span>{this.renderLabel(setting)}</span>
                </div>
            </div>
        );
    }
    ...
    buildUsernameSetting = (id, setting) => {
        return (
            <UserAutocompleteSetting
                ...
                label={this.renderLabel(setting)}
                helpText={this.renderHelpText(setting)}
                placeholder={Utils.localizeMessage(setting.placeholder) || Utils.localizeMessage('search_bar.search', 'Search')}
                value={this.state[id] || ''}
                disabled={this.isDisabled(setting)}
                onChange={this.handleChange}
            />
